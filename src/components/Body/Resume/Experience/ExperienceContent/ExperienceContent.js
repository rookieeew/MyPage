...
function ExperienceContent() {
    ...
    return (
        <div className={"experience-content-container"}>
            ...
            {/*    />*/}
            {/*</svg>*/}
            <ul className={"experience-contents"} ref={ref}>
                <li>
                ...
                <li>
                    <div className={"experience-content"}>
                        <p className={"experience-content-year"}><span
                            className={"experience-content-month"}>Dec</span> 2023
                        ...
                        <p className={"experience-content-name"}>Information Visualize,Distributed Healthy Management
                            System, <a className={"project-link"} href={"https://github.com/rookieeew/DHMS"}>DHMS</a>
                        </p>
                        ...
                        <ul className={"experience-content-details"}>
                            ...
                            <li>Employ diverse protocols to establish connections with various microservices, ensuring
                                efficient
                ...
                <li>
                    <div className={"experience-content"}>
                        <p className={"experience-content-year"}><span
                            className={"experience-content-month"}>Jun</span> 2023 -
                            <span className={"experience-content-month"}>Aug</span> 2023</p>
                        <p className={"experience-content-name"}>Back-end Leader, Find quiet places and roads for users
                            in
                        ...
                        <ul className={"experience-content-details"}>
                            ...
                            <li>Experienced in developing algorithms for optimal route determination from source to
                                target
                                points
                            </li>
                            <li>Skilled in Docker deployment for hosting projects on both UCD's server infrastructure
                                and AWS
                                cloud platform
                            </li>
                        </ul>
