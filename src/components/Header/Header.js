        ...
        <div className={`header ${isScrolled ? 'scrolled' : ''}`}>
            ...
            <div className={"center"}>
                <ul>
                    ...
                    <li className={"nav-item"} onClick={() => scrollToSection('whatIDo')}>What I Do</li>
                ...
                <ul>
                    <li className={"social-icon"}>
                        <a href={"https://www.linkedin.com/in/rookieeew/"}>
                            <svg t="1706522385969" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    ...
                    <li className={"social-icon"}>
                        <a href={"https://github.com/rookieeew"}>
                            <svg href={"https://github.com/rookieeew"}
                                 t="1706483751565" className="icon" viewBox="0 0 1024 1024" version="1.1"
